                  ...
                  <div className="p-5">
                    ...
                    <div className="flex justify-between mb-3">
                      ...
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                        product.soLuong > 5 ? 'bg-green-100 text-green-700' : 
                        product.soLuong > 0 ? 'bg-yellow-100 text-yellow-700' : 'bg-red-100 text-red-700'
                      }`}>
                        SL: {product.soLuong}
                      </span>
                    </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            ...
            <p className="text-lg font-bold mb-4">
              Thành tiền: <span className="text-red-600">{(selectedProduct.donGia * quantity).toLocaleString()}₫</span>
            </p>
